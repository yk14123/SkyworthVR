...
public class RtrBluetoothConnectedDialog extends AppCompatDialog {

    private View mContentView;

    public RtrBluetoothConnectedDialog(@NonNull Context context) {
        super(context, R.style.VrModeMainDialog);
        init(context);
    }

    private void init(Context context) {
        mContentView = LayoutInflater.from(context).inflate(R.layout.rtr_dialog_bluetooth_connected, null);
