...
public class VideoContentList {
    ...
    private int menuVideoDuration;
    private int type;

    public int getMenuVideoDuration() {
        return menuVideoDuration;
    }

    public void setMenuVideoDuration(int menuVideoDuration) {
        this.menuVideoDuration = menuVideoDuration;
    }
