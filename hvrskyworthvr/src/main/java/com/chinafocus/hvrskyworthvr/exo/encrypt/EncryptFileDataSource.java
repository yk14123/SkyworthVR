 ...
 */
public final class EncryptFileDataSource extends BaseDataSource {

    /**
     * Thrown when a {@link EncryptFileDataSource} encounters an error reading a file.
     */
    ...
    /**
     * {@link DataSource.Factory} for {@link EncryptFileDataSource} instances.
     */
    public static final class Factory implements DataSource.Factory {
        ...
        /**
         * Sets a {@link TransferListener} for {@link EncryptFileDataSource} instances created by this factory.
         *
        ...
        @Override
        public EncryptFileDataSource createDataSource() {
            EncryptFileDataSource dataSource = new EncryptFileDataSource();
            if (listener != null) {
    ...
    public long open(DataSpec dataSpec) throws FileDataSourceException {
        try {
            ...
            file.seek(dataSpec.position + offset);
            bytesRemaining = dataSpec.length == C.LENGTH_UNSET ? file.length() - dataSpec.position - offset
                    : dataSpec.length;
            if (bytesRemaining < 0) {
