 ...
 *       if constructed using {@link #MyDefaultDataSource(Context, String, boolean)}, or any other
 *       schemes supported by a base data source if constructed using {@link
 *       #MyDefaultDataSource(Context, DataSource)}.
 * </ul>
 */
public final class MyDefaultDataSource implements DataSource {
   ...
   */
  public MyDefaultDataSource(Context context, boolean allowCrossProtocolRedirects) {
    this(
        context,
        /* userAgent= */ null,
   ...
   */
  public MyDefaultDataSource(Context context, DataSource baseDataSource) {
...
//      fileDataSource = new FileDataSource();
      fileDataSource = new EncryptFileDataSource();
