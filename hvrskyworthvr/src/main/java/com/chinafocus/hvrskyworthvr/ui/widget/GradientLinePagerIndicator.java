 ...
 * 自定义渐变色的Indicator
 */
public class GradientLinePagerIndicator extends View implements IPagerIndicator {
...
//        }
        ...
        if (mGradientColors != null && mGradientColors.length > 1) {
            mPaint.setShader(new LinearGradient(mLineRect.left, (mLineRect.bottom - mLineRect.top) / 2, mLineRect.right, (mLineRect.bottom - mLineRect.top) / 2,
